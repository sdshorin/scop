...
SRCS_LIST = main.c parse_obj_file.c mat4.c mat4_2.c vec3.c vec3_2.c create_shader.c parse_bmp.c \
input.c tools.c opengl_init.c main_loop.c parse_figure.c tools_2.c
HEADERS_LIST = scop.h
